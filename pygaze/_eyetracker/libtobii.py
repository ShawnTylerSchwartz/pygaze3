...
class TobiiProTracker(BaseEyeTracker):
    ...
    def __init__(self, display, logfile=settings.LOGFILE,
        ...
        # initialize keyboard
        self.kb=Keyboard(disptype=settings.DISPTYPE, keylist=['escape','space','q'], timeout=1)
        #self.kb = Keyboard(keylist=['space', 'escape', 'q'], timeout=1)#commented out by nicole
        ...
        if hasattr(settings, 'TRACKERSERIALNUMBER'):
            print(settings.TRACKERSERIALNUMBER,settings.SCREENSIZE,self.disp.dispsize)#added by Nicole
            ...
            print('tracker serial number isnt there bitch')#added by Nicole
    ...
    def calibrate(self, calibrate=True, validate=True):
        ...
        if calibrate:
            ...
            print(origin, size)#added by nicole
            ...
            while calibrating:
                ...
                for point in self.points_to_calibrate:
                    ...
                    clock.pause(1000)#1000)#change by Nicole
        ...
        if validate:
            ...
            # # calculate RMS noise -- THIS WAS EDITED BY NICOLE TO AVOID ISSUES WITH CALIBRATION THAT CAUSE THE SOFTWARE TO CRASH
            # This edit change can be found in this thread: https://forum.cogsci.nl/discussion/4653/include-recalibration-in-the-middle-of-the-experiment-drift-correction-is-prone-to-crash-or-stuck
            Xvar, Yvar = [], []
