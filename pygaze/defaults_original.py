...
DISPSIZE = (1920,1080)#(1920,1080)#(1280,1024) #(3072,1920) #canvas size
SCREENSIZE = (53,29.5)#(33.8,27.1) # physical screen size in centimeters
SCREENDIST = 57.0 # centimeters; distance between screen and participant's eyes
FULLSCREEN = False#True # Indicates whether the experiment is executed in fullscreen
...
TRACKERSERIALNUMBER = 'TPNA1-030210214015' # serial number of eye tracker
